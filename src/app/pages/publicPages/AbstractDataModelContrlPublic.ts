import {Injectable, OnDestroy, QueryList, ViewChild, ViewChildren} from '@angular/core';
...
import {SqSort} from "../../appCommon/cofigurations/SqSort";
...
export abstract class AbstractDataModelContrlPublic<T> extends UtilityController implements OnDestroy  {
    ...
    protected constructor(public service: AbstractDataModelService<T>  ) {
        ...
        this.appSettings = AppInjector.get<AppSettings>(AppSettings);
        this.msgsService = AppInjector.get<MessagesService>(MessagesService);
        this.dropDownServices = AppInjector.get<DropDownService>(DropDownService);
        this.formsManager=AppInjector.get<AkitaNgFormsManager>(AkitaNgFormsManager);
        this.authService=AppInjector.get<AuthService>(AuthService);
    ...
    public prepareFiltersFormGroup(filterPropertiesArr: Array<FilterProperty>) {
        ...
        filterPropertiesArr.forEach((fileProperty) => {
            ...
            formControl.setValue(fileProperty.value);
