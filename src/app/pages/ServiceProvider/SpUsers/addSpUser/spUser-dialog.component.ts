...
@Component({
    selector: 'app-spUsers-dialog',
    templateUrl: './spUser-dialog.component.html',
    styleUrls: ['./spUser-dialog.component.scss']

})
export class SpUserDialogComponent implements OnInit {
    ...
    constructor(public dialogRef: MatDialogRef<SpUserDialogComponent>,
    ...
    prepareAllPermsForPart() {
        ...
        this.permsService.getAllPermsByPartyId(PartiesEnum.SERVICE_PROVIDER).subscribe(data => {
            this.perms = data;
        });
    ...
    public saveUser(values: Object): void {
         if (this.form.valid) {
            ...
            this.submitted = true;
            this.userService.addUserToRepSp(this.regUser).subscribe(
                data => {
