...
import {HiringVResvSpDialogComponent} from "./hiringVResvSp-dialog.component";
import {ResrvServiceSp} from "../../../../services/reservations/sp/ResrvServiceSp";


@Component({
    selector: 'app-hiring-resv-v-sp',
    templateUrl: './hiringVResvSp.component.html',
    encapsulation: ViewEncapsulation.None,

})

export class HiringVResvSpComponent extends AbstractDataModelController<SvHiringReservation> implements OnInit {
    public repId:number;
    constructor(
        public dialog: MatDialog, public dropDownServices: DropDownService,
        public service: ResrvServiceSp, public router: Router ) {
        super(service);
