...
import {InputDataModel} from 'src/app/appCommon/models/dto/InputDataModel';
import {Observable} from 'rxjs';
import {ResponseDataModel} from 'src/app/appCommon/models/dto/ResponseDataModel';
...
@Injectable()
export class MailboxService extends AbstractDataModelService<Mail> {
    constructor(private httpClient: HttpClient) {
        super();

    }

    loadData(inputDataModel: InputDataModel): Observable<ResponseDataModel<Mail>> {
        return this.httpClient.post<ResponseDataModel<Mail>>(Constants.URL + '/api/tickets/getFiltersSortedData', inputDataModel);
    }

    loadTicketDetByTicketId(mail: Mail): Observable<Array<Mail>> {
        return this.httpClient.post<Array<Mail>>(Constants.URL + '/api/tickets/getTicketDetails', mail);
    }

    addNewTicket(data: Mail): Observable<ResponseDto> {
        return this.httpClient.post<ResponseDto>(Constants.URL + '/api/tickets/addNewTicket', data);
    }


    closeTicket(data: Mail): Observable<ResponseDto> {
        return this.httpClient.post<ResponseDto>(Constants.URL + '/api/tickets/closeTicket', data);
    }


    addNewTicketDet(data: Mail): Observable<ResponseDto> {
        return this.httpClient.post<ResponseDto>(Constants.URL + '/api/tickets/addNewTicketDet', data);
    }

    setAsRead(data: Mail): Observable<ResponseDto> {
        return this.httpClient.post<ResponseDto>(Constants.URL + '/api/tickets/setTicketDetAsRead', data);
    }

    getById(id: number): Observable<Mail> {
       return this.httpClient.post<Mail>(Constants.URL + '/api/tickets/getById', {"ticketId":id});
    }
    ...
    public getMail(id: number | string) {
        return Mails.find(mail => mail.ticketId === +id);
    }
}
