...
import {UsersDialogComponent} from './adminUsersOps/users-dialog.component';
import {IdUserNameDto} from '../../../models/DTO/IdUserNameDto';
import {EditUsersPemDialogComponent} from './adminUsersOps/editUsersPerm/editUsersPem-dialog.component';
...
export class AdminUserComponent extends AbstractDataModelController<SysRepUser> implements OnInit {
    constructor(
    ...
    editUserPermission(user: User) {
        let dialogRef = this.dialog.open(EditUsersPemDialogComponent, {
            data: user,
            disableClose: true,
            height: '400px',
            width: '600px',
