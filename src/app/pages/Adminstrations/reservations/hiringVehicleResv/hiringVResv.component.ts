...
import {HiringVResvDialogComponent} from "./hiringVResv-dialog.component";
import {ResrvServiceAdmin} from "../../../../services/reservations/admin/ResrvServiceAdmin";


@Component({
    selector: 'app-hiring-resv-v_admin',
    templateUrl: './hiringVResv.component.html',
    encapsulation: ViewEncapsulation.None,

})

export class HiringVResvComponent extends AbstractDataModelController<SvHiringReservation> implements OnInit {
    public repId:number;
    constructor(
        public dialog: MatDialog, public dropDownServices: DropDownService,
        public service: ResrvServiceAdmin, public router: Router ) {
        super(service);
        this.formsManager.upsert('resrevationsHiringAdmin', this.filterComponentForm);
    ...
    viewResv( resv: SvHiringReservation) {
        let dialogRef = this.dialog.open(HiringVResvDialogComponent, {
            data: resv,
            disableClose: true,
            height: '500px',
            width: '900px',
