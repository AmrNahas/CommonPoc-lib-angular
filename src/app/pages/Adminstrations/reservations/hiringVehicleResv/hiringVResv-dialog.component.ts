...
@Component({
    selector: 'app-hiringResvAdmin-dialog',
    templateUrl: './hiringVResv-dialog.component.html',

})
export class HiringVResvDialogComponent extends UtilityController implements OnInit {
    ...
    constructor(public dialogRef: MatDialogRef<HiringVResvDialogComponent>,
