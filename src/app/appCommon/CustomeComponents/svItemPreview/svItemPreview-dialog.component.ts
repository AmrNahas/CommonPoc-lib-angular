...
@Component({
    selector: 'app-item-preview-dialog',
    templateUrl: './svItemPreview.component.html',
    styleUrls: ['./svItemPreview.component.scss']

})
export class SvItemPreviewDialogComponent implements OnInit {
