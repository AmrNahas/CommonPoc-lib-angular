...
export class ResrvServiceAdmin extends AbstractDataModelService<SvHiringReservation> {
    ...
    loadData(inputDataModel: InputDataModel): Observable<ResponseDataModel<SvHiringReservation>> {
        return this.http.post<ResponseDataModel<SvHiringReservation>>(Constants.URL+'/api/admin/VehicleHiringReservations/getFiltersSortedData', inputDataModel);
